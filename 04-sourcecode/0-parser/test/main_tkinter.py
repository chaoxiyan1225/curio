...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.buttonOpen = customtkinter.CTkButton(self.download_frame, text="Open", image=self.more_img)
    ...
    def downLoading(self, url, savePath, name):
        ...
        try:
           self.downloadP.downLoadStart(url, savePath, name)
