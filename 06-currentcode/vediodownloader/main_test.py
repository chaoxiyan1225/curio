...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.current_label =  customtkinter.CTkLabel(self.download_frame, corner_radius=0, height=30,  text=f" 0%", fg_color="transparent", text_color=("gray10", "gray90"), anchor="w", font=customtkinter.CTkFont(size=15, weight="bold"))
